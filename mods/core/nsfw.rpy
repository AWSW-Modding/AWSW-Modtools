...
screen nsfw_ok_promt(string):
    ...
    frame xalign 0.5 yalign 0.5 at popup_custom_nsfw:
        ...
        vbox at popup_custom_nsfw:
            ...
            textbutton "OK":
                action [Play("audio", "se/sounds/yes.wav"), Hide("nsfw_ok_promt", Dissolve(1.0))],
                hovered [Play("audio", "se/sounds/select.ogg")]
                style "yesnobutton"
...
label NSFW_warning:
    ...
    python:
        ...
        if player_input == True:
            ...
            dummy = mts_ok_promt("You have enabled NSFW scenes.")

        elif player_input == False:
            renpy.pause(0.8)
            renpy.play("fx/system.wav", "sound")
            dummy = mts_ok_promt("You have disabled NSFW scenes.")
        ...
        frame xalign 0.05 yalign 0.07:
            ...
            hbox:
                ...
                imagebutton:
                    ...
                    hover im.Scale("ui/nsfw_chbox-unchecked.png", 70, 70)
                    selected_idle im.Scale("ui/nsfw_chbox-checked.png", 70, 70)
                    selected_hover im.Scale("ui/nsfw_chbox-checked.png", 70, 70)
                    action [mts_TogglePersistentBool("showNSFWWarning"),
        ...
        frame:
            ...
            vbox:
                ...
                hbox:
                    ...
                    textbutton "Yes":
                        if not fromStartUp:
                            action [mts_SetPersistent("nsfwtoggle", True),
                                    SetVariable("nsfwtoggle", True),
                                    Play("audio", "se/sounds/yes.wav"),
                                    Hide("nsfw_toggle_screen", None),
                                    Show("nsfw_ok_promt", dissolve, "You have enabled NSFW scenes.")]
                        else:
                            action [mts_SetPersistent("nsfwtoggle", True),
                                    SetVariable("nsfwtoggle", True),
                                    Play("audio", "se/sounds/yes.wav"),
                    ...
                    textbutton "No":
                        if not fromStartUp:
                            action [mts_SetPersistent("nsfwtoggle", False),
                                    SetVariable("nsfwtoggle", False),
                                    Play("audio", "se/sounds/close.ogg"),
                                    Hide("nsfw_toggle_screen", None),
                                    Show("nsfw_ok_promt", dissolve, "You have disabled NSFW scenes.")]
